...
<div class="pull-left1">
  <h2 style="font-weight:bold; font-family: 'Corbel'; color:rgb(150, 8, 10);"> 
    <span><img src="images/casuallist.jpg" height="40px"></span> <b style="font-size:20px; letter-spacing:3px;">Casual Employee List</b>
  </h2>
</div>
<hr>
  ...
  <tbody>
    <?php
      ...
      while($rowz=mysql_fetch_array($query)){
        $id = $rowz['a_id'];
        $info = mysql_query("SELECT * from tbl_applicants where a_id = '$id' AND a_status = 'Casual' ORDER BY ID DESC")or die(mysql_error());
    ...
    <tr style="text-transform: uppercase; font-size: 13px;">
      ...
      <td><center><a href="employee_view.php?id=<?= $row['a_id'] ?>&type=Casual" class="btn btn-xs btn-success">View</a></center></td>
    </tr>
    <?php
    $num++;
    }
