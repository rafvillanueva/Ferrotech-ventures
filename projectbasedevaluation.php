...
if(isset($_GET['type'])){
    ...
    if($count == 0){
        ...
        ?>
            <script type="text/javascript">
                ...
                window.location.href = 'projectbasedevaluation.php?id=<?= $id ?>';
            </script>
        <?php
    }else{
        ?>
    ...
    ?>
    <script type="text/javascript">window.location.href = 'projectbasedevaluation.php?id=<?= $id ?>'</script>
    <?php
}elseif(isset($_GET['promote'])){
    $id = $_GET['id'];
    $type = $_GET['typezz'];

    $sql = "UPDATE tbl_applicants SET a_status = 'Regular' WHERE a_id = '$id'";
    $rs = mysqli_query($conn, $sql);

    ?>
    <script type="text/javascript">window.location.href = 'projectbasedeval_list.php'</script>
    <?php
}
?>
<!DOCTYPE html>
...
<div class="sidebar col-sm-12 col-md-12 col-lg-6" style="margin-top:-20px;">
    <a href="projectbasedeval_list.php" style="text-decoration: none;"><li><span style="font-family: 'Calibri'"><img src="images/RETURN.png" height="35px"> &nbsp; RETURN </span></li></a>
...
<h2 style="margin-left: 22%; margin-top:2%; "> 
  <img src="images/emp_rating.png" height="50px" width="50px"> <b style="letter-spacing: 2px; font-family: 'Calibri';">Projectbased Evaluation</b></h2>
<div class="table-responsive container col-xs-6 col-md-6 col-lg-6" style="margin-left:18px;  width: 1065px;"> 
    ...
    <div class="panel panel-default">
        <div class="panel-heading" style=" letter-spacing: 2px;">
            ...
            <div class="pull-right" style="position: relative; top: -7px; left: 12px;"> <a href="projectbased_endconform.php?id=<?= $id ?>" class="btn btn-warning btn-md">End Contact</a></div>
            <br>
        </div>
        <div class="panel-body">
            ...
            <hr>
            <?php
            $verify = mysqli_query($conn, "SELECT * FROM tbl_ratings WHERE a_id = '$id' AND a_type = 'Project Based'");
            $count = mysqli_num_rows($verify);
...
<div class="panel panel-primary">
        <div class="panel-heading" style="letter-spacing:4px;"><span class="glyphicon glyphicon-list"></span> Score adjectival</div>
            ...
            <tr>
                <th align="left"> 1. Knowledge of Work:
                    ...
                    <input type="hidden" name="status" id="status" value="Project Based">
        ...
        <div id="confirm_panel">
            <button class="btn btn-success btn-md" type="button" onclick="confirm()">
        ...
        <div id="final_panel" style="display: none;">
            ...
            <button onclick="saved_rate_prj()" type="button" name="btn_add_user" class="btn btn-primary">
        ...
        <div class="panel-heading" style="letter-spacing:4px;"><span class="glyphicon glyphicon-list"></span>Persformance Rating Scale</div>
            ...
            <center>
                ...
                <div id="front_panel">
                    ...
                    <button href="" class="btn btn-md btn-success" onclick="Yes()">Yes. I want to promote this.</button>
                ...
                <div id="yes_panel" style="display: none;">
                    ...
                    <a href="Projectbasedevaluation.php?id=<?= $id ?>&typezz=projectbased&promote" class="btn btn-md btn-success">
                        Confirm
                    </a>
                    <button class="btn btn-md btn-danger" onclick="Yes_cancel()">Cancel</button>
                </div>
                <div id="no_panel" style="display: none;">
                    <h2><b style="font-family: Corbel; letter-spacing: 0px;">
                        DO YOU WANT TO EVALUATE AGAIN ?</b>
                    </h2>
                    <a href="projectbasedevaluation.php?id=<?= $id ?>&typez=Project Based&evaluate" class="btn btn-md btn-success">
                        Confirm
                    </a>
