...
<!--end modal-->
   ...
   <h2 style="font-weight:bold; font-family:oblique; color:rgb(150, 8, 10); margin-left: 22%; margin-top:2%;"> 
      <span class="glyphicon glyphicon-th-list"></span> Regular Employee Ratings
  
  </h2>


<form  style="margin-right:73px;" method="POST" action="regularevalsearch.php" class="navbar-search pull-right">
...
<thead>
    ...
    <th colspan="2" style="width: 10%;"><center>Action</center></th>
      ...
      <th><center>Date end Contract</center></th>
 ...
 <tr>
      ...
      <td><center><a  href="regularevaluation.php<?php echo '?id='.$row['id']; ?>" class="glyphicon glyphicon-edit edit_btn  btn-primary btn btn-md">Evaluate</a></center></td>

<td>
    <center><a href="regular_endconform.php<?php echo '?id='.$row['id']; ?>" style="text-decoration: none; margin-top: 2px;" class=" glyphicon glyphicon-remove-circle edit_btn  btn-danger btn btn-md">EndCon</a>
</center> 
</td>
  ...
  <td><?php echo $row['ratingsregular'] ; ?></td>
