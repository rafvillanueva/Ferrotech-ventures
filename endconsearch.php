...
<!--end modal-->
   ...
   <h2 style="font-weight:bold; font-family:oblique; color:rgb(150, 8, 10); margin-left: 22%; margin-top:2%;"> 
      <span class="glyphicon glyphicon-th-list"></span> End Contract Employee
  
  </h2>


<form  style="margin-right:19px;" method="POST" action="endconsearch.php" class="navbar-search pull-right">
...
<thead>
    ...
    <th><center>Action</center></th>
      ...
      <th><center>Date&nbsphired</center></th>
      <th><center>End contract</center></th>
    </tr>
    ...
    <?php
                                    if (isset($_POST['search'])){
                                        ...
                                        $search=$_POST['search'];                                     
                                        $query=mysql_query("SELECT * from table_list where (idnumber like '%$search%' or firstname like '%$search%' or lastname like '%$search%' or middlename like '%$search%') AND record_status = 'endcon'")or die(mysql_error());
 ...
 <tr>
      ...
      <td><center><a href="endconview.php<?php echo '?id='.$row['id']; ?>" class=" glyphicon glyphicon-eye-open edit_btn  btn-primary btn btn-md"></a></center></td>
