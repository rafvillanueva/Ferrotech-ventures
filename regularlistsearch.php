...
<!--end modal-->
   ...
   <h2 style="font-weight:bold; font-family:oblique; color:rgb(150, 8, 10); margin-left: 22%; margin-top:2%;"> 
      ...
      <form style="margin-right:73px;" method="POST" action="regularlistsearch.php" class="navbar-search pull-right">
...
<?php
           if (isset($_POST['search'])){                        
                $search=$_POST['search'];                                     
                $query=mysql_query("SELECT * from table_list where (idnumber like '%$search%' or firstname like '%$search%' or lastname like '%$search%' or middlename like '%$search%') AND record_status = 'regular'")or die(mysql_error());
                  while($row=mysql_fetch_array($query)){
              $id=$row['id'];
?>
<tr> 

      <td><center><a href="regularview.php<?php echo '?id='.$row['id']; ?>" class="btn btn-primary glyphicon glyphicon-eye-open btn-md"data-toggle="tooltip" data-placement="top" title="View"></a></center>
</td>



<td>
     <center><a style="text-decoration: none; margin-top: 2px;" class=" glyphicon glyphicon-edit edit_btn  btn-info btn btn-md" href="reg_emp_list_edit.php<?php echo '?id='.$row['id']; ?>"data-toggle="tooltip" data-placement="top" title="Edit"></a></center></td>


<td>
      <center><a href="regular_termination.php<?php echo '?id='.$row['id']; ?>" style="text-decoration: none;" class="glyphicon glyphicon-warning-sign edit_btn  btn-warning btn btn-md" data-toggle="tooltip" data-placement="top" title="Terminate"></a></center></td>

     <td><center><a href="regular_blockform.php<?php echo '?id='.$row['id']; ?>" style="text-decoration: none; margin-top: 2px;"class=" glyphicon glyphicon-ban-circle btn-danger btn btn-md" data-toggle="tooltip" data-placement="top" title="Block"></a></center></td>
