...
<!--end modal-->
<h2 style="font-weight:bold;  margin-left: 22%; margin-top:2%;">
  <span><img src="images/Untitled-5-512.png" height="40px"></span> <b style="font-size:20px; letter-spacing: 3px;">Applicant Verification & Approving</b>
</h2>
<br><br>
  ...
  if(isset($_POST['btn_waiting_hired'])){
    ...
    if($count == 0){
      ...
      <script type="text/javascript">
        ...
        window.location.href = 'endcon_list.php'
      </script>
      <?php
