...
<head>
     ...
     <title>Projectbased Evaluation</title>
...
<!--end modal-->
   ...
   <h2 style="font-weight:bold; font-family:oblique; color:rgb(150, 8, 10); margin-left: 22%; margin-top:2%;"> 
      <span class="glyphicon glyphicon-th-list"></span> Projectbased Employee Ratings
  
  </h2>


<form  style="margin-right:73px;" method="POST" action="projectbasedevalsearch.php" class="navbar-search pull-right">
...
<thead>
 ...
 <tr>
          <td><center><a href="projectbased_promote.php<?php echo '?id='.$row['id']; ?>" style="text-decoration: none; height: 35px;" class=" glyphicon glyphicon-ok-circle btn-success btn btn-md" >Promote</a></center></td>


      <td><center><a  href="projectbasedevaluation.php<?php echo '?id='.$row['id']; ?>" class="glyphicon glyphicon-edit edit_btn  btn-primary btn btn-md">Evaluate</a></center></td>

<td>
    <center><a href="projectbased_endconform.php<?php echo '?id='.$row['id']; ?>" style="text-decoration: none; margin-top: 2px;" class=" glyphicon glyphicon-remove-circle edit_btn  btn-danger btn btn-md">EndCon</a>
</center> 
</td>
  ...
  <td><?php echo $row['ratingsprojectbased'] ; ?></td>
