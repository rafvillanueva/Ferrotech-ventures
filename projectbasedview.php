...
<tr>
      ...
      <th style="background:white;" colspan="6"><a href="projectbased_list.php" type="button" class="btn btn-primary" style="font-family: oblique; margin-top: 15px;"><span class="glyphicon glyphicon-menu-left"></span>BACK</a> <center><h3 style="font-family: oblique;margin-top: -30px;"><img src="images/view_icon.png">EMPLOYEE DETAIL'S</h3></center></th>
</tr>
</thead>
<tbody>     
<tr style="font-family: oblique;">
	...
	<td style="font-family: oblique;">Evaluation ratings<input class="form-control" name="ratingscasual" value="<?php echo $table_list_rows['ratingsprojectbased']; ?>"  disabled></input></td>
...
<tr style="font-family: oblique;">
	...
	<td>End contract<input class="form-control" type="date" name="endconprojectbased" value="<?php echo $table_list_rows['endconprojectbased']; ?>" disabled></input></td>
...
<tr>
	<td colspan="2" style="font-family: oblique;">Reason<textarea class="form-control"disabled name="projectbased_foffense"><?php echo $table_list_rows['projectbased_foffense'];?></textarea></td>


	<td colspan="2" style="font-family: oblique;">Reason<textarea class="form-control" name="projectbased_soffense"disabled><?php echo $table_list_rows['projectbased_soffense']; ?></textarea></td>
	
    <td colspan="2" style="font-family: oblique;">Reason<textarea class="form-control" name="projectbased_toffense" disabled><?php echo $table_list_rows['projectbased_toffense']; ?></textarea></td>
</tr>
