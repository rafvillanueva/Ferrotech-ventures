 			...
 			<thead> 
				<tr>
      			<th  colspan="6" style="letter-spacing: 2px; background-image: url(images/r.jpg); background-size: cover; background-repeat: no-repeat;">
      						...
      						<h3 style="font-family:'Calibri'; letter-spacing: 6px; color: white; font-weight: bold; font-size:20px;"><img src="images/endcon.png" width="40px" height="40px"> CASUAL END CONTRACT FORM</h3>
				...
				<tr>
					<td colspan="6" class="active" style="font-family:'Calibri'">
							<button style="letter-spacing: 5px; font-size: 15px;" name="btn_endcon" type="submit" class="btn btn-success" style="font-family:'Calibri'"><span class="glyphicon glyphicon-check"></span>CONFIRM</button>
      						...
      						<a style="letter-spacing: 5px; font-size: 15px;" href="casualevaluation.php?id=<?= $id ?>&casual" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-check"></span>EVALUATE</a>
					</td>
				</tr>
		    </tbody>
		</table>
