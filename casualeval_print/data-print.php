...
<button style="font-family: oblique;" class="btn btn-primary" type="submit" id="print" onclick="printPage()">Go!</button>
		<center><img src="../images/print_logo.jpg" height="170px;" width="750px" style="margin-top: -50px;"></center>
			<p style = "margin-left:30px; margin-top: -70px; font-size:30pt; font-weight:bold;  text-align:center;"><center><h4 style="font-weight: bold;font-family:oblique; margin-left: 20px;">CASUAL EVALUATION LIST</h4></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
<?php
					...
					$result = $database->prepare ("SELECT * FROM table_list where record_status = 'casual' order by id DESC");
?>
...
?>
							<tr>
								...
								<td style="text-align:center;"><?php echo $row_member['ratingscasual']; ?></td>
							</tr>
