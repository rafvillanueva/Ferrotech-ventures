...
<button style="font-family: oblique;" class="btn btn-primary" type="submit" id="print" onclick="printPage()">Go!</button>
			...
			<p style = "margin-left:30px; margin-top: -70px; font-size:30pt; font-weight:bold;  text-align:center;"><center><h4 style="font-weight: bold;font-family:oblique; margin-left: 20px;">REGULAR EVALUATION LIST</h4></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <div align="right">
...
?>
							<tr>
								...
								<td style="text-align:center;"><?php echo $row_member['ratingsregular']; ?></td>
							</tr>
