...
<!--end modal-->
   ...
   <h2 style="font-weight:bold; font-family:oblique; color:rgb(150, 8, 10); margin-left: 22%; margin-top:2%;"> 
      ...
      <form style="margin-right:73px;" method="POST" action="casuallistsearch.php" class="navbar-search pull-right">
...
<tr> 
      ...
      <td><center><a href="casualview.php<?php echo '?id='.$row['id']; ?>" class="btn btn-primary glyphicon glyphicon-eye-open btn-md"data-toggle="tooltip" data-placement="top" title="View"></a></center>
</td>



<td>
     <center><a style="text-decoration: none; margin-top: 2px;" class=" glyphicon glyphicon-edit edit_btn  btn-info btn btn-md" href="casual_edit.php<?php echo '?id='.$row['id']; ?>"data-toggle="tooltip" data-placement="top" title="Edit"></a></center></td>


<td>
      <center><a href="casual_termination.php<?php echo '?id='.$row['id']; ?>" style="text-decoration: none;" class="glyphicon glyphicon-warning-sign edit_btn  btn-warning btn btn-md" data-toggle="tooltip" data-placement="top" title="Terminate"></a></center></td>

     <td><center><a href="casual_blockform.php<?php echo '?id='.$row['id']; ?>" style="text-decoration: none; margin-top: 2px;"class=" glyphicon glyphicon-ban-circle btn-danger btn btn-md" data-toggle="tooltip" data-placement="top" title="Block"></a></center></td>
