...
<tr>
      ...
      <div style="margin-top: 5px;">  
              ...
              <a href="reg_emp_list.php" type="button" class="btn btn-danger btn-md glyphicon glyphicon-remove">Cancel</a>
      </div>
...
<tr>
  ...
  <td colspan="2"> <center>FIRST OFFENSE REASON</center><textarea class="form-control" disabled><?php echo $table_list_rows['regular_foffense']; ?></textarea></td>
  <td colspan="3"> <center>SECOND OFFENSE REASON</center><textarea class="form-control" disabled><?php echo $table_list_rows['regular_soffense']; ?></textarea></td>
</tr>
<tr>
  <td colspan="5"> <center>THIRD OFFENSE REASON</center><textarea class="form-control" disabled><?php echo $table_list_rows['regular_toffense']; ?></textarea></td>
</tr>
...
mysql_query("UPDATE table_list set record_status = 'block' where id='$id'");
  ...
  echo "<script>alert('Successfully Blocked !'); window.location='reg_emp_list.php'</script>";
