  ...
  <body>
    ...
    <div class="container">
      ...
      <form method="post" action="data-print.php" target="_new" class="form-inline">
        ...
        <a href="http://localhost/OLD%20HRIS/analysis&reporting.php">
        ...
        <label style="font-family:oblique; font-size:25px; margin-left:280px;margin-top: 10px;">CASUAL EMPLOYEE LIST</label>
        </div>
      </form>
          </th>
        </tr>
