...
<a href="casualeval_print"class="btn btn-primary"><span class=" glyphicon glyphicon-share" style="margin-right: 2px; margin-top:1px;"></span>REPORT</a>
</div>

   <h2 style="font-weight:bold; font-family:oblique; color:rgb(150, 8, 10); margin-left: 22%; margin-top:2%;"> 
      <span><img src="images/casuallist.jpg" height="40px"></span> Casual Ratings
...
<?php
    $table_list_query=mysql_query("SELECT * from table_list where record_status = 'casual'");
...
?>
  ...
  <td><?php echo $table_list_rows['ratingscasual'] ; ?></td>
